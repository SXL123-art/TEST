...
const QMetaObjectExtraData showDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject showDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_showDialog,
      qt_meta_data_showDialog, &staticMetaObjectExtraData }
};
